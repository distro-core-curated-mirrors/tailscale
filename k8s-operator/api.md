...
| `replicas` _integer_ | Replicas specifies how many instances of tsrecorder to run.<br />https://tailscale.com/kb/1115/high-availability. Defaults to 1. |  | Minimum: 0 <br /> |
