...
func (s *Server) start() (reterr error) {
	...
	authKey, err := s.resolveAuthKey(oauthOk, wifOk, resolveViaOAuth, resolveViaWIF)
	if err != nil {
...
type oauthResolver func(ctx context.Context, clientSecret string, tags []string) (string, error)
type wifResolver func(ctx context.Context, baseURL, clientID, idToken string, tags []string) (string, error)

func (s *Server) resolveAuthKey(oauthAvailable bool, wifAvailable bool, resolveViaOAuth oauthResolver, resolveViaWIF wifResolver) (string, error) {
